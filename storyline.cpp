...
void displayStoryline()
{
    ...
    typewriterEffect("After all that partying, you wander the streets drunk and exausted. As your trying your best to make your way back home, you cross the street.");
    typewriterEffect("You look to your left, and see a blinding flash of light. -BAM-, truck-kun smacks you right into the pavement at 100 miles an hour");
    ...
    typewriterEffect("You look up and your not even in your country anymore. Your in a beautiful grassland and you hear someone shouting 'Kael, Kael!' ");
    typewriterEffect("A lady tells you to come back home, that dinner is ready. She speaks in a foreign language but for some reason you understand it.");
    typewriterEffect("Turns out you have been transported to a random world and you are now a 10 year old child. The world is a lot different than your old world");
