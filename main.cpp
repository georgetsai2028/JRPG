...
int main()
{
    //storyline summary, put in seperate file later and add ascii art 
    cout << "You are an average salaryman in Japan, walking home late after celebration party for your promotion" << endl;
    cout << "After all that partying, you wander the streets drunk and exausted. As your trying your best to make your way back home, you cross the street." << endl;
    ...
    cout << "Looking down to the ground, your stunned to what has happened. Surprisingly, you don't feel any sort of pain, getting up and brushing it off like nothing happen" << endl;
    cout << "For some reason the ground looks 3 feet closer than it usually does. You look at your hands and feet, thinking 'why do they look smaller than normal'." << endl;
    cout << "You look up and your not even in your country anymore. Your in a beautiful grassland and you hear someone shouting 'Kael, Kael!' " << endl;
    ...
    cout << "Everyone uses magic, and are sent to a magic academy when you turn and leave when you graduate." << endl;
