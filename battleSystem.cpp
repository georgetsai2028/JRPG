        ...
        if (choice == 1)
         { 
            ...
            if (hasSword) 
            {
                ...
                {
                    cout << "You attack the enemy with your sword for " << player.attackPower << " damage!\n";
             ...
             else if (hasStaff) 
             {
                ...
                {
                    cout << "Not enough mana to perform a magical attack. You default to a physical attack.\n";
                    if (rand() % 100 < 15) 
                    {
            ...
            else 
            {
                ...
                {
                    cout << "You attack the enemy with a basic physical attack for " << player.attackPower << " damage!\n";
                    enemy.health -= player.attackPower;
                }
            }
        } 
